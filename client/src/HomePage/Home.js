            ...
            <div className="Container--Home" >
                <div className="main--Home" onClick={(  ) => this.HideTypeList()}>
                    <Row className="NavBar--Home">
                        ...
                        <Col xs={3} sm={3} lg={3} xl={3} className="LoginBtnContainer--Home">
        <Button variant="outline-info" onClick={()=> this.RedirectLoginPage()}>{this.state.logedIn ? this.state.LOGOUT : this.state.LOGIN}</Button>
                        </Col>
                    </Row>
